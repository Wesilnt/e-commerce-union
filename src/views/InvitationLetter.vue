    ...
    export default {
        data() {
            ...
            return {
                ...
                shareUrl: `${window.location.href.split('#')[0]}#/home/joinDistributor?presidentInfo=${this.$route.query.presidentInfo}`,
                user: {},
                pixelRatio: 1,                          //像素比
                radio,                                  //
                canvasW,                                //canvas宽度
        ...
        methods: {
            ...
            async drawTip1(resolve) {
                const presidenter =  JSON.parse(decode(decodeURIComponent(this.presidentInfo)))
